...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        self.cammino = ft.ElevatedButton("Cammino minimo", width=200,
                                                      on_click=self.controller.handler_cammino)

        row3= ft.Row([self.cammino], alignment=ft.MainAxisAlignment.CENTER)
